...
public class PlantActivity extends AppCompatActivity {
    ...
    private MaterialTextView plant_LBL_back,plant_LBL_edit;
    private CircleImageView plant_IMG_plantImage;
    private AppCompatTextView plant_LBL_title, plant_LBL_lastUpdate;
    private MaterialTextView plant_EDT_status,plant_EDT_notes;
    private LinearLayoutCompat plant_LL_homeGardener,plant_LL_wildDiscovery,plant_LL_notes;
    private AppCompatTextView plant_LBL_plantingDate,plant_LBL_watering;
    private AppCompatTextView plant_LBL_observationDate,plant_LBL_Location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plant_LBL_back.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        plant_LBL_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openEditActivity();
            }
    ...
    private void getData() {
        ...
        plant_LBL_lastUpdate.setText("Last Update: " +receivedPlant.getLastUpdate());
